...
struct FAnimNode_AnimDynamics : public FAnimNode_SkeletalControlBase
{
	...
	struct FBoneReference                              RelativeSpaceBone;                                        // 0x0078(0x0018) (CPF_Edit)
	bool                                               bChain;                                                   // 0x0090(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0091(0x0007) MISSED OFFSET
	struct FBoneReference                              BoundBone;                                                // 0x0098(0x0018) (CPF_Edit)
	struct FBoneReference                              ChainEnd;                                                 // 0x00B0(0x0018) (CPF_Edit)
	struct FVector                                     BoxExtents;                                               // 0x00C8(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	struct FVector                                     LocalJointOffset;                                         // 0x00D4(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	float                                              GravityScale;                                             // 0x00E0(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bLinearSpring;                                            // 0x00E4(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bAngularSpring;                                           // 0x00E5(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	bool                                               bEnableWind;                                              // 0x00F0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	float                                              WindScale;                                                // 0x00F4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bOverrideLinearDamping;                                   // 0x00F8(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	bool                                               bOverrideAngularDamping;                                  // 0x0100(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	bool                                               bOverrideAngularBias;                                     // 0x0108(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	bool                                               bDoUpdate;                                                // 0x0110(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bDoEval;                                                  // 0x0111(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	struct FAnimPhysConstraintSetup                    ConstraintSetup;                                          // 0x011C(0x005C) (CPF_Edit)
	bool                                               bUsePlanarLimit;                                          // 0x0178(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData08[0x7];                                       // 0x0179(0x0007) MISSED OFFSET
	TArray<struct FAnimPhysPlanarLimit>                PlanarLimits;                                             // 0x0180(0x0010) (CPF_Edit, CPF_ZeroConstructor)
	bool                                               bUseSphericalLimits;                                      // 0x0190(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData09[0x7];                                       // 0x0191(0x0007) MISSED OFFSET
	TArray<struct FAnimPhysSphericalLimit>             SphericalLimits;                                          // 0x0198(0x0010) (CPF_Edit, CPF_ZeroConstructor)
...
{
	struct FBoneReference                              BoneToModify;                                             // 0x0070(0x0018) (CPF_Edit)
	TArray<struct FConstraint>                         ConstraintSetup;                                          // 0x0088(0x0010) (CPF_Edit, CPF_ZeroConstructor)
	TArray<float>                                      ConstraintWeights;                                        // 0x0098(0x0010) (CPF_Edit, CPF_EditFixedSize, CPF_ZeroConstructor)
...
{
	struct FBoneReference                              SourceBone;                                               // 0x0070(0x0018) (CPF_Edit)
	struct FBoneReference                              TargetBone;                                               // 0x0088(0x0018) (CPF_Edit)
	...
	TEnumAsByte<EBoneControlSpace>                     ControlSpace;                                             // 0x00A3(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FAnimNode_CopyBoneDelta : public FAnimNode_SkeletalControlBase
{
	...
	bool                                               bCopyRotation;                                            // 0x00A1(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bCopyScale;                                               // 0x00A2(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	ECopyBoneDeltaMode                                 CopyMode;                                                 // 0x00A3(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FAnimNode_Fabrik : public FAnimNode_SkeletalControlBase
{
	...
	TEnumAsByte<EBoneControlSpace>                     EffectorTransformSpace;                                   // 0x00A0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x00A1(0x0007) MISSED OFFSET
	struct FBoneReference                              EffectorTransformBone;                                    // 0x00A8(0x0018) (CPF_Deprecated)
	struct FBoneSocketTarget                           EffectorTarget;                                           // 0x00C0(0x0060) (CPF_Edit)
	TEnumAsByte<EBoneRotationSource>                   EffectorRotationSource;                                   // 0x0120(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0121(0x0007) MISSED OFFSET
	struct FBoneReference                              TipBone;                                                  // 0x0128(0x0018) (CPF_Edit)
	struct FBoneReference                              RootBone;                                                 // 0x0140(0x0018) (CPF_Edit)
	float                                              Precision;                                                // 0x0158(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                MaxIterations;                                            // 0x015C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bEnableDebugDraw;                                         // 0x0160(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	struct FBoneReference                              RightHandFK;                                              // 0x0070(0x0018) (CPF_Edit)
	struct FBoneReference                              LeftHandFK;                                               // 0x0088(0x0018) (CPF_Edit)
	struct FBoneReference                              RightHandIK;                                              // 0x00A0(0x0018) (CPF_Edit)
	struct FBoneReference                              LeftHandIK;                                               // 0x00B8(0x0018) (CPF_Edit)
	TArray<struct FBoneReference>                      IKBonesToMove;                                            // 0x00D0(0x0010) (CPF_Edit, CPF_ZeroConstructor)
...
{
	struct FBoneReference                              BoneToModify;                                             // 0x0070(0x0018) (CPF_Edit)
	struct FBoneReference                              LookAtBone;                                               // 0x0088(0x0018) (CPF_Deprecated)
	struct FName                                       LookAtSocket;                                             // 0x00A0(0x0008) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x8];                                       // 0x00A8(0x0008) MISSED OFFSET
	struct FBoneSocketTarget                           LookAtTarget;                                             // 0x00B0(0x0060) (CPF_Edit)
	struct FVector                                     LookAtLocation;                                           // 0x0110(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	TEnumAsByte<EAxisOption>                           LookAtAxis;                                               // 0x011C(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x011D(0x0003) MISSED OFFSET
	struct FVector                                     CustomLookAtAxis;                                         // 0x0120(0x000C) (CPF_Deprecated, CPF_IsPlainOldData)
	struct FAxis                                       LookAt_Axis;                                              // 0x012C(0x0010) (CPF_Edit)
	bool                                               bUseLookUpAxis;                                           // 0x013C(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EAxisOption>                           LookUpAxis;                                               // 0x013D(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x013E(0x0002) MISSED OFFSET
	struct FVector                                     CustomLookUpAxis;                                         // 0x0140(0x000C) (CPF_Deprecated, CPF_IsPlainOldData)
	struct FAxis                                       LookUp_Axis;                                              // 0x014C(0x0010) (CPF_Edit)
	float                                              LookAtClamp;                                              // 0x015C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EInterpolationBlend>                   InterpolationType;                                        // 0x0160(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0161(0x0003) MISSED OFFSET
	float                                              InterpolationTime;                                        // 0x0164(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              InterpolationTriggerThreashold;                           // 0x0168(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FAnimNode_ModifyBone : public FAnimNode_SkeletalControlBase
{
	...
	TEnumAsByte<EBoneModificationMode>                 TranslationMode;                                          // 0x00AC(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EBoneModificationMode>                 RotationMode;                                             // 0x00AD(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EBoneModificationMode>                 ScaleMode;                                                // 0x00AE(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     TranslationSpace;                                         // 0x00AF(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     RotationSpace;                                            // 0x00B0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     ScaleSpace;                                               // 0x00B1(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	struct FBoneReference                              TargetBone;                                               // 0x0070(0x0018) (CPF_Edit)
	struct FBoneReference                              SourceBone;                                               // 0x0088(0x0018) (CPF_Edit)
	float                                              Multiplier;                                               // 0x00A0(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EBoneAxis>                             RotationAxisToRefer;                                      // 0x00A4(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bIsAdditive;                                              // 0x00A5(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	struct FBoneReference                              StartBone;                                                // 0x0070(0x0018) (CPF_Edit)
	struct FBoneReference                              EndBone;                                                  // 0x0088(0x0018) (CPF_Edit)
	ESplineBoneAxis                                    BoneAxis;                                                 // 0x00A0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bAutoCalculateSpline;                                     // 0x00A1(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x00A2(0x0002) MISSED OFFSET
	int                                                PointCount;                                               // 0x00A4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	struct FAlphaBlend                                 TwistBlend;                                               // 0x00C8(0x0038) (CPF_Edit)
...
{
	struct FBoneReference                              SpringBone;                                               // 0x0070(0x0018) (CPF_Edit)
	bool                                               bLimitDisplacement;                                       // 0x0088(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0089(0x0003) MISSED OFFSET
	float                                              MaxDisplacement;                                          // 0x008C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              SpringStiffness;                                          // 0x0090(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              SpringDamping;                                            // 0x0094(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              ErrorResetThresh;                                         // 0x0098(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bNoZSpring;                                               // 0x009C(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	bool                                               bTranslateX;                                              // 0x009D(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bTranslateY;                                              // 0x009E(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bTranslateZ;                                              // 0x009F(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bRotateX;                                                 // 0x00A0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bRotateY;                                                 // 0x00A1(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bRotateZ;                                                 // 0x00A2(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	struct FBoneReference                              TrailBone;                                                // 0x0070(0x0018) (CPF_Edit)
	int                                                ChainLength;                                              // 0x0088(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EAxis>                                 ChainBoneAxis;                                            // 0x008C(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bInvertChainBoneAxis;                                     // 0x008D(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	struct FRuntimeFloatCurve                          TrailRelaxationSpeed;                                     // 0x0098(0x0078) (CPF_Edit)
	bool                                               bLimitStretch;                                            // 0x0110(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0111(0x0003) MISSED OFFSET
	float                                              StretchLimit;                                             // 0x0114(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FVector                                     FakeVelocity;                                             // 0x0118(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	bool                                               bActorSpaceFakeVel;                                       // 0x0124(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0125(0x0003) MISSED OFFSET
	struct FBoneReference                              BaseJoint;                                                // 0x0128(0x0018) (CPF_Edit)
...
{
	struct FBoneReference                              IKBone;                                                   // 0x0070(0x0018) (CPF_Edit)
	unsigned char                                      bAllowStretching : 1;                                     // 0x0088(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0089(0x0003) MISSED OFFSET
	float                                              StartStretchRatio;                                        // 0x008C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              MaxStretchScale;                                          // 0x0090(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FVector2D                                   StretchLimits;                                            // 0x0094(0x0008) (CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      bTakeRotationFromEffectorSpace : 1;                       // 0x009C(0x0001) (CPF_Edit)
	unsigned char                                      bMaintainEffectorRelRot : 1;                              // 0x009C(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x009D(0x0003) MISSED OFFSET
	TEnumAsByte<EBoneControlSpace>                     EffectorLocationSpace;                                    // 0x00A0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x00A1(0x0007) MISSED OFFSET
	struct FName                                       EffectorSpaceBoneName;                                    // 0x00A8(0x0008) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	struct FVector                                     EffectorLocation;                                         // 0x00B0(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x00BC(0x0004) MISSED OFFSET
	struct FBoneSocketTarget                           EffectorTarget;                                           // 0x00C0(0x0060) (CPF_Edit)
	TEnumAsByte<EBoneControlSpace>                     JointTargetLocationSpace;                                 // 0x0120(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0121(0x0003) MISSED OFFSET
	struct FVector                                     JointTargetLocation;                                      // 0x0124(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	struct FName                                       JointTargetSpaceBoneName;                                 // 0x0130(0x0008) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      UnknownData05[0x8];                                       // 0x0138(0x0008) MISSED OFFSET
	struct FBoneSocketTarget                           JointTarget;                                              // 0x0140(0x0060) (CPF_Edit)
	bool                                               bAllowTwist;                                              // 0x01A0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x01A1(0x0003) MISSED OFFSET
	struct FAxis                                       TwistAxis;                                                // 0x01A4(0x0010) (CPF_Edit)
	bool                                               bNoTwist;                                                 // 0x01B4(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
...
// 0x01A0 (0x06E0 - 0x0540)
struct FAnimSequencerInstanceProxy : public FAnimInstanceProxy
{
	unsigned char                                      UnknownData00[0x1A0];                                     // 0x0540(0x01A0) MISSED OFFSET
};
