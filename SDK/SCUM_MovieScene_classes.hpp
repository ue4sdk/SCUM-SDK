...
public:
	...
	struct FMovieSceneEasingSettings                   Easing;                                                   // 0x00B8(0x0038) (CPF_Edit)
	float                                              StartTime;                                                // 0x00F0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              EndTime;                                                  // 0x00F4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                RowIndex;                                                 // 0x00F8(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                OverlapPriority;                                          // 0x00FC(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bIsActive : 1;                                            // 0x0100(0x0001) (CPF_Edit)
	unsigned char                                      bIsLocked : 1;                                            // 0x0100(0x0001) (CPF_Edit)
	unsigned char                                      bIsInfinite : 1;                                          // 0x0100(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0101(0x0003) MISSED OFFSET
	float                                              PrerollTime;                                              // 0x0104(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              PostrollTime;                                             // 0x0108(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	struct FMovieSceneEvaluationTemplate               PrecompiledEvaluationTemplate;                            // 0x00B0(0x02F8)
	EMovieSceneCompletionMode                          DefaultCompletionMode;                                    // 0x03A8(0x0001) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	bool                                               bParentContextsAreSignificant;                            // 0x03A9(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	float                                              TimeCursorPosition;                                       // 0x03D8(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              StartTime;                                                // 0x03DC(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              EndTime;                                                  // 0x03E0(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                CurrentNumLoops;                                          // 0x03E4(0x0004) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
...
{
public:
	struct FMovieSceneSectionParameters                Parameters;                                               // 0x0110(0x0014) (CPF_Edit)
	float                                              StartOffset;                                              // 0x0124(0x0004) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	float                                              TimeScale;                                                // 0x0128(0x0004) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	float                                              PrerollTime;                                              // 0x012C(0x0004) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	class UMovieSceneSequence*                         SubSequence;                                              // 0x0130(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TLazyObjectPtr<class AActor>                       ActorToRecord;                                            // 0x0138(0x001C) (CPF_Edit, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0154(0x0004) MISSED OFFSET
	struct FString                                     TargetSequenceName;                                       // 0x0158(0x0010) (CPF_Edit, CPF_ZeroConstructor)
	struct FDirectoryPath                              TargetPathToRecordTo;                                     // 0x0168(0x0010) (CPF_Edit)
