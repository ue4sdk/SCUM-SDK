...
struct FConstraintData
{
	...
	struct FName                                       TargetNode;                                               // 0x0010(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              Weight;                                                   // 0x0018(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bMaintainOffset;                                          // 0x001C(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
