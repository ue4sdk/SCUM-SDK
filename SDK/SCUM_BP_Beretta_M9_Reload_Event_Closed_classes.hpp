...
#include "SCUM_BP_Beretta_M9_Reload_Event_Closed_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_Beretta_M9_Reload_Event_Closed.BP_Beretta_M9_Reload_Event_Closed_C");
		return ptr;
	}
