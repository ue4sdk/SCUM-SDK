...
#include "SCUM_BP_Continental_House_07_Stable_classes.hpp"
...
// Function BP_Continental_House_07_Stable.BP_Continental_House_07_Stable_C.GetWindowMarkers
// (FUNC_Event, FUNC_Public, FUNC_HasOutParms, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
// TArray<struct FWindowMarker>   Result                         (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor)

void ABP_Continental_House_07_Stable_C::GetWindowMarkers(TArray<struct FWindowMarker>* Result)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Continental_House_07_Stable.BP_Continental_House_07_Stable_C.GetWindowMarkers");
