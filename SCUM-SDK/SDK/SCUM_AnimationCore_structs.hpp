...
#include "SCUM_AnimationCore_enums.hpp"
...
struct FAimConstraintDescription : public FConstraintDescriptionEx
{
	...
	struct FVector                                     LookUpTarget;                                             // 0x0034(0x000C) (CPF_Edit, CPF_IsPlainOldData)
};
...
struct FEulerTransform
{
	...
	struct FVector                                     Scale;                                                    // 0x0018(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
};
