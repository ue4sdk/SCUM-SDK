...
#include "SCUM_ReplicationGraph_structs.hpp"
...
public:
	...
	TArray<class UReplicationGraphNode*>               GlobalGraphNodes;                                         // 0x0088(0x0010) (CPF_ZeroConstructor)
	TArray<class UReplicationGraphNode*>               PrepareForReplicationNodes;                               // 0x0098(0x0010) (CPF_ZeroConstructor)
...
{
public:
	class UReplicationGraphNode_GridSpatialization2D*  GridNode;                                                 // 0x01F0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UReplicationGraphNode_ActorList*             AlwaysRelevantNode;                                       // 0x01F8(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	TArray<struct FConnectionAlwaysRelevantNodePair>   AlwaysRelevantForConnectionList;                          // 0x0200(0x0010) (CPF_ZeroConstructor)
	TArray<class AActor*>                              ActorsWithoutNetConnection;                               // 0x0210(0x0010) (CPF_ZeroConstructor)
...
{
public:
	class UReplicationGraphNode_DormancyNode*          DormancyNode;                                             // 0x0150(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	class UReplicationGraphNode*                       ChildNode;                                                // 0x00A0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	class AActor*                                      LastViewer;                                               // 0x0160(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class AActor*                                      LastViewTarget;                                           // 0x0168(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	TArray<struct FTearOffActorInfo>                   TearOffActors;                                            // 0x00A0(0x0010) (CPF_ZeroConstructor)
...
public:
	...
	class AReplicationGraphDebugActor*                 DebugActor;                                               // 0x0120(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0128(0x0008) MISSED OFFSET
	TArray<class UReplicationGraphNode*>               ConnectionGraphNodes;                                     // 0x0130(0x0010) (CPF_ZeroConstructor)
	class UReplicationGraphNode_TearOff_ForConnection* TearOffNode;                                              // 0x0140(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
