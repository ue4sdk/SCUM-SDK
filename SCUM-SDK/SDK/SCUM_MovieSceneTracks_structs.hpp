...
#include "SCUM_MovieSceneTracks_enums.hpp"
...
struct FMovieSceneEventSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	TArray<struct FMovieSceneObjectBindingID>          EventReceivers;                                           // 0x00A8(0x0010) (CPF_ZeroConstructor)
...
struct FMovieSceneFadeSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	struct FLinearColor                                FadeColor;                                                // 0x00C0(0x0010) (CPF_IsPlainOldData)
...
struct FMovieSceneVector4KeyStruct : public FMovieSceneVectorKeyStructBase
{
	...
	struct FVector4                                    Vector;                                                   // 0x0030(0x0010) (CPF_Edit, CPF_IsPlainOldData)
};
...
{
	struct FVector                                     Vector;                                                   // 0x0028(0x000C) (CPF_Edit, CPF_IsPlainOldData)
...
{
	struct FVector2D                                   Vector;                                                   // 0x0028(0x0008) (CPF_Edit, CPF_IsPlainOldData)
};
