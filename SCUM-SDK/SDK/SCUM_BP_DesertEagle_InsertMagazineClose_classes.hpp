...
#include "SCUM_BP_DesertEagle_InsertMagazineClose_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_DesertEagle_InsertMagazineClose.BP_DesertEagle_InsertMagazineClose_C");
		return ptr;
	}
