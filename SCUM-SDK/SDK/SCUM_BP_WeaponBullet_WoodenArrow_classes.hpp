...
#include "SCUM_BP_WeaponBullet_WoodenArrow_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_WeaponBullet_WoodenArrow.BP_WeaponBullet_WoodenArrow_C");
		return ptr;
	}
