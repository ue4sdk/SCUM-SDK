...
#include "SCUM_UI_NotificationPanelWidget_classes.hpp"
...
// Parameters:
// class UNotificationWidget*     notification                   (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData)
...
void UUI_NotificationPanelWidget_C::ShowNotification(class UNotificationWidget* notification)
{
	...
	struct
	{
		class UNotificationWidget*     notification;
	} params;
