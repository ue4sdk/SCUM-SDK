...
public:
	...
	TMap<struct FString, struct FLevelSequenceObject>  PossessedObjects;                                         // 0x0440(0x0050) (CPF_ZeroConstructor, CPF_Deprecated)
...
public:
	...
	struct FSoftClassPath                              BurnInClass;                                              // 0x0030(0x0018) (CPF_Edit, CPF_BlueprintVisible, CPF_Config)
...
public:
	...
	struct FSoftObjectPath                             LevelSequence;                                            // 0x0380(0x0018) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly)
...
{
public:
	struct FLevelSequencePlayerSnapshot                FrameInformation;                                         // 0x0208(0x0058) (CPF_BlueprintVisible, CPF_BlueprintReadOnly)
	class ALevelSequenceActor*                         LevelSequenceActor;                                       // 0x0260(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	struct FScriptMulticastDelegate                    OnCameraCut;                                              // 0x07E0(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
	unsigned char                                      UnknownData00[0x30];                                      // 0x07F0(0x0030) MISSED OFFSET
	TArray<class UObject*>                             AdditionalEventReceivers;                                 // 0x0820(0x0010) (CPF_ZeroConstructor, CPF_Transient)
