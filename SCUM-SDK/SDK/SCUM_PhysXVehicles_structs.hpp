...
#include "SCUM_PhysXVehicles_enums.hpp"
...
struct FWheelSetup
{
	...
	struct FVector                                     AdditionalOffset;                                         // 0x0010(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	bool                                               bDisableSteering;                                         // 0x001C(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
