...
#include "SCUM_GameplayTasks_structs.hpp"
...
public:
	...
	bool                                               bIsNetDirty;                                              // 0x00F8(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	struct FScriptMulticastDelegate                    OnClaimedResourcesChange;                                 // 0x0158(0x0010) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference)
