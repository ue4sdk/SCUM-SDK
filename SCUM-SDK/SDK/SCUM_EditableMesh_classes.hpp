...
#include "SCUM_EditableMesh_structs.hpp"
...
public:
	...
	TArray<class UEditableMeshAdapter*>                Adapters;                                                 // 0x0D78(0x0010) (CPF_ZeroConstructor)
	int                                                TextureCoordinateCount;                                   // 0x0D88(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0xF8];                                      // 0x0D8C(0x00F8) MISSED OFFSET
	int                                                PendingCompactCounter;                                    // 0x0E84(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                SubdivisionCount;                                         // 0x0E88(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
