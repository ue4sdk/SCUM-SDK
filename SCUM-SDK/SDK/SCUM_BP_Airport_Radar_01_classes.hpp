...
{
public:
	class UStaticMeshComponent*                        SM_Airport_Radar_01_Grates;                               // 0x0328(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData)
	...
	TArray<struct FLadderMarker>                       LadderMarkers;                                            // 0x0340(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance)
