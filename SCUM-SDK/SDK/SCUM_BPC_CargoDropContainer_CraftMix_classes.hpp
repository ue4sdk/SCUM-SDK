...
#include "SCUM_BPC_CargoDropContainer_CraftMix_structs.hpp"
...
public:
	...
	class UStaticMeshComponent*                        fefef;                                                    // 0x0458(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData)
	...
	class UStaticMeshComponent*                        StaticMesh2;                                              // 0x0468(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BPC_CargoDropContainer_CraftMix.BPC_CargoDropContainer_CraftMix_C");
		return ptr;
	}
