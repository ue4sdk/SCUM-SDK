...
#include "SCUM_BP_DesertEagle_Reload_Event_Opened_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_DesertEagle_Reload_Event_Opened.BP_DesertEagle_Reload_Event_Opened_C");
		return ptr;
	}
