...
#include "SCUM_NavigationSystem_structs.hpp"
...
public:
	...
	unsigned char                                      bCanBeMainNavData : 1;                                    // 0x03A0(0x0001) (CPF_Edit, CPF_Config, CPF_EditConst)
...
public:
	...
	float                                              DefaultDrawDistance;                                      // 0x0538(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	float                                              DefaultMaxSearchNodes;                                    // 0x053C(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	float                                              DefaultMaxHierarchicalSearchNodes;                        // 0x0540(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	TEnumAsByte<ERecastPartitioning>                   RegionPartitioning;                                       // 0x0544(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	TEnumAsByte<ERecastPartitioning>                   LayerPartitioning;                                        // 0x0545(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0546(0x0002) MISSED OFFSET
	int                                                RegionChunkSplits;                                        // 0x0548(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	int                                                LayerChunkSplits;                                         // 0x054C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      bSortNavigationAreasByCost : 1;                           // 0x0550(0x0001) (CPF_Edit, CPF_Config)
	unsigned char                                      bPerformVoxelFiltering : 1;                               // 0x0550(0x0001) (CPF_Edit, CPF_Config)
	unsigned char                                      bMarkLowHeightAreas : 1;                                  // 0x0550(0x0001) (CPF_Edit, CPF_Config)
	unsigned char                                      bFilterLowSpanSequences : 1;                              // 0x0550(0x0001) (CPF_Edit, CPF_Config)
	unsigned char                                      bFilterLowSpanFromTileCache : 1;                          // 0x0550(0x0001) (CPF_Edit, CPF_Config)
	unsigned char                                      bDoFullyAsyncNavDataGathering : 1;                        // 0x0550(0x0001) (CPF_Edit, CPF_Config)
	unsigned char                                      bUseBetterOffsetsFromCorners : 1;                         // 0x0550(0x0001) (CPF_Config)
	unsigned char                                      bStoreEmptyTileLayers : 1;                                // 0x0550(0x0001) (CPF_Config)
	unsigned char                                      bUseVirtualFilters : 1;                                   // 0x0551(0x0001) (CPF_Config)
	unsigned char                                      bAllowNavLinkAsPathEnd : 1;                               // 0x0551(0x0001) (CPF_Config)
	unsigned char                                      bUseVoxelCache : 1;                                       // 0x0551(0x0001) (CPF_Config)
	unsigned char                                      UnknownData03[0x2];                                       // 0x0552(0x0002) MISSED OFFSET
	float                                              TileSetUpdateInterval;                                    // 0x0554(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	float                                              HeuristicScale;                                           // 0x0558(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	float                                              VerticalDeviationFromGroundCompensation;                  // 0x055C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
...
public:
	...
	struct FColor                                      DrawColor;                                                // 0x0038(0x0004) (CPF_Edit, CPF_Config, CPF_IsPlainOldData)
...
{
public:
	unsigned char                                      bStrictlyStatic : 1;                                      // 0x0040(0x0001) (CPF_Edit)
	unsigned char                                      bCreateOnClient : 1;                                      // 0x0040(0x0001) (CPF_Edit)
	unsigned char                                      bAutoSpawnMissingNavData : 1;                             // 0x0040(0x0001) (CPF_Edit)
	unsigned char                                      bSpawnNavDataInNavBoundsLevel : 1;                        // 0x0040(0x0001) (CPF_Edit)
...
public:
	...
	struct FVector                                     QueryingExtent;                                           // 0x0380(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	...
	struct FVector                                     ProjectedLocation;                                        // 0x0398(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_EditConst, CPF_IsPlainOldData)
	...
	struct FVector2D                                   TextCanvasOffset;                                         // 0x03AC(0x0008) (CPF_Edit, CPF_IsPlainOldData)
...
public:
	...
	TArray<struct FNavigationLink>                     Links;                                                    // 0x0568(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor)
...
public:
	...
	struct FVector                                     ObstacleOffset;                                           // 0x0160(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	struct FVector                                     ObstacleExtent;                                           // 0x016C(0x000C) (CPF_Edit, CPF_IsPlainOldData)
...
public:
	...
	struct FVector                                     FailsafeExtent;                                           // 0x0128(0x000C) (CPF_Edit, CPF_IsPlainOldData)
