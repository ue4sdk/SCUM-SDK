...
#include "SCUM_ClothingSystemRuntime_enums.hpp"
...
struct FClothConfig
{
	...
	float                                              AnimDriveSpringStiffness;                                 // 0x00BC(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              AnimDriveDamperStiffness;                                 // 0x00C0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
