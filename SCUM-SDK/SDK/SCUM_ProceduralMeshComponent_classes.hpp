...
{
public:
	bool                                               bUseComplexAsSimpleCollision;                             // 0x0590(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bUseAsyncCooking;                                         // 0x0591(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x6];                                       // 0x0592(0x0006) MISSED OFFSET
	class UBodySetup*                                  ProcMeshBodySetup;                                        // 0x0598(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData)
	TArray<struct FProcMeshSection>                    ProcMeshSections;                                         // 0x05A0(0x0010) (CPF_ZeroConstructor)
	TArray<struct FKConvexElem>                        CollisionConvexElems;                                     // 0x05B0(0x0010) (CPF_ZeroConstructor)
	struct FBoxSphereBounds                            LocalBounds;                                              // 0x05C0(0x001C) (CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x05DC(0x0004) MISSED OFFSET
	TArray<class UBodySetup*>                          AsyncBodySetupQueue;                                      // 0x05E0(0x0010) (CPF_ZeroConstructor, CPF_Transient)
